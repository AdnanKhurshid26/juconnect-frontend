...
<div className="p-2 flex flex-row gap-2 border-2  lg:items-center border-slate-200 rounded-md lg:w-6/12">    
    ...
    {/* <div class="w-full md:w-1/2 xl:w-1/3 pt-3 px-3 md:pl-2 xl:pl-3 xl:pr-2">
        <div class="bg-purple-600 border rounded shadow p-2">
            <div class="flex flex-row items-center">
                ...
                <div class="flex-1 text-right">
                    <h5 class="text-white">Meetings Today</h5>
                    <h3 class="text-white text-3xl">1</h3>
                </div>
            </div>
        </div>
    </div> */}
...
<div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        <div className="grid grid-cols-5 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8">
